...
function AboutUs() {
  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Vaishali's Little Greens today and experience the 
